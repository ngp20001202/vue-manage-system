...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: '/parcel/batchCalculation',
                name: 'parcel-batchCalculation',
                meta: {
                    title: '批量试算',
                    permiss: '100',
                },
            ...
            {
                path: '/parcel/postingToLastMiler',
                name: 'parcel-postingToLastMiler',
                meta: {
                    title: '推送入网',
                    permiss: '100',
                },
            ...
            {
                // 辅助页：导入预览（?fileid=xxx），不在主菜单中
                path: '/parcel/previewPage',
                name: 'parcel-previewPage',
                meta: {
                    title: '导入预览',
                    permiss: '100',
                },
                component: () => import(/* webpackChunkName: "parcel-previewPage" */ '../views/parcel/previewPage.vue'),
            },
            {
                // 辅助页：推送入网预览（?fileid=xxx），不在主菜单中
                path: '/parcel/postingPreviewPage',
                name: 'parcel-postingPreviewPage',
                meta: {
                    title: '推送预览',
                    permiss: '100',
                },
                component: () => import(/* webpackChunkName: "parcel-postingPreviewPage" */ '../views/parcel/postingPreviewPage.vue'),
            },
            {
                path: '/parcel/cancel',
                name: 'parcel-cancel',
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "printing" */ '../views/printing/index.vue'),
            },
